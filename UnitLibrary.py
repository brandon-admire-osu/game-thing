...
class Unit():
    ...
    def __init__(self,tier,mobility,team=0,owner_id=0,keywords=KEYWORDS_INIT,location=None,order=("defend",None),wounds=0,bannar=None,captain=False):
        # Basic info
        self.tier = tier
        self.mobility = mobility
        self.team = team #-1 for dire, 1 for radient
        self.owner_id = owner_id
        self.keywords = keywords # Used to track keywords
        self.special_flags = [False,False,False,False,False,False,False] # Used to indicate special behavior at specific game step

        # Current state info
        self.wound = wounds # unit destroyed if wounds == 1
        self.location = location | Node(None,None,None) #Dummy node for new units
        self.order = order
...
class Scouts(Unit):
    ...
    2 members
    """
    def __init__(self, team, owner_id, location, bannar, order, captain=False, wounds=0):
        super().__init__(1, 2, team, owner_id, bannar=bannar, captain=captain, location=location, order=order, wounds=wounds)
...
class InfantrySquad(Unit):
    ...
    def __init__(self, team, owner_id, location, bannar, order, captain=False, wounds=0):
        if captain:
            super().__init__(1, 1, team, owner_id, bannar=bannar, captain=captain, location=location, order=order, wounds=wounds)
            self.special_flags[6] = True #Special ability activates during cleanup

        else:
            super().__init__(1, 1, team, owner_id, bannar=bannar, location=location, order=order, wounds=wounds)
        return self
...
class Calvary(Unit):
    ...
    """
    def __init__(self, team, owner_id, location, bannar, order, captain=False, wounds=0):
        super().__init__(2, 3, team, owner_id, bannar=bannar, captain=captain, location=location, order=order, wounds=wounds)
        return self
...
class Artillary(Unit):
    ...
    1 member
    """
    def __init__(self, team, owner_id, location, order, captain=False, wounds=0):
        super().__init__(1, 1, team, owner_id, captain=captain, location=location, order=order, wounds=wounds)
...
class BattlefieldMedic(Unit):
    ...
    """
    def __init__(self, team, owner_id, location, order, captain=False, wounds=0):
        super().__init__(2, 1, team, owner_id, captain=captain, location=location, order=order, wounds=wounds)
        self.keywords["Fragile"] = True
...
class HeavyInfantry(Unit):
    ...
    """
    def __init__(self, team, owner_id, location, bannar, order, captain=False, wounds=0):
        super().__init__(2, 1, team, owner_id, bannar=bannar, captain=captain, location=location, order=order, wounds=wounds)
...
class Assasin(Unit):
    ...
    """
    def __init__(self, team, owner_id, location, order, captain=False, wounds=0):
        super().__init__(2, 2, team, owner_id, captain=captain, location=location, order=order, wounds=wounds)
...
class Warrior(Unit):
    ...
    """
    def __init__(self, team, owner_id, location, order, captain=False, wounds=0):
        super().__init__(3, 1, team, owner_id, captain=captain, location=location, order=order, wounds=wounds)
...
class Necromancer(Unit):
    ...
    def __init__(self, team, owner_id, location, bannar, order, captain=False, wounds=0):
        super().__init__(3, 1, team, owner_id, bannar=bannar, captain=True, location=location, order=order, wounds=wounds)
